(function(root) {
  ...
  var S = F.Substitutions = function(s) { 
    if (s) {
      return merge({}, s);
    }
    return this;
  ...
  S.prototype.lookup = function(lv, v) {
    var found = this[lv.name];
  ...
  S.prototype.extend = function(key, value) {
    var obj = {};
    obj[key] = value;
    return new S(merge(this, obj));
  };

  S.prototype.unify = function(l, r) {
    var t1, t2;
    ...
    if (isArray(t1) && isArray(t2)) {
      return new S(merge(this.unify(car(t1), car(t2)), this.unify(cdr(t1), cdr(t2))));
    }
    return this;
  };  
  var emptyS = F.emptyS = new S();
